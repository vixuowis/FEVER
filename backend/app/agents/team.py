...
EXPERT_IDS = ["event_scout", "market_analyst", "fundamentals_analyst", "deep_researcher"]
...
当问题涉及「原因拆解/假设验证/多源交叉」时，可以单独只派 deep_researcher（不开其他 expert）；
反之纯事实/快讯类问题不必派 deep_researcher。"""
